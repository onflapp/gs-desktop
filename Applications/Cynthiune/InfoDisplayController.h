...
@class CynthiuneFadingTextField;
...
@interface InfoDisplayController : NSObject
{
  ...
  CynthiuneFadingTextField *songArtistField;
  CynthiuneFadingTextField *songAlbumField;
  CynthiuneFadingTextField *songNumberField;
  NSTextField *songTimerField;
  CynthiuneFadingTextField *songTitleField;
