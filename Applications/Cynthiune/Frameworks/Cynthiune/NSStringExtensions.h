/* NSStringExtensions.h - this file is part of Cynthiune
 *
...
#ifndef NSSTRINGEXTENSIONS_H
#define NSSTRINGEXTENSIONS_H

#import <Foundation/NSString.h>

@interface NSString (CynthiuneExtension)
